...
assert.equal((qrView.match(/className="h-full pt-0 sm:pt-20 sm:pb-28"/g) || []).length, 2);
assert.equal((qrView.match(/top-\[50px\][^"\n]*hidden[^"\n]*sm:flex/g) || []).length, 2);
...
assert.match(serviceWorker, /becoartes-kiosk-v1\.9\.11/);
