...
export const ProductSchema = z.object({
  ...
  costSource: z.enum(['cmv', 'stock', 'manual']).optional(),
  cmvId: z.string().optional(),
  cmvStatus: z.enum(['complete', 'empty', 'incomplete', 'direct_stock', 'missing']).optional(),
  cmvIngredientCount: z.number().optional(),
  cmvUnlinkedCount: z.number().optional(),
