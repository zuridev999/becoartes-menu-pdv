...
export function QRView() {
  ...
  return (
    <div className="flex h-full max-h-full min-h-0 flex-col overflow-hidden bg-[#0a0a0c] text-white font-['Outfit']">
      ...
      <div
        className="h-[calc(100%-3.5rem)] max-h-[calc(100%-3.5rem)] min-h-0 flex-none overflow-hidden sm:h-[calc(100%-5rem)] sm:max-h-[calc(100%-5rem)] sm:pb-28"
...
function ComandaQRExperience({
  ...
  return (
    <div className="flex h-full max-h-full min-h-0 flex-col overflow-hidden bg-[#0a0a0c] text-white font-['Outfit']">
      ...
      <div
        className="h-[calc(100%-4rem)] max-h-[calc(100%-4rem)] min-h-0 flex-none overflow-hidden sm:h-[calc(100%-5rem)] sm:max-h-[calc(100%-5rem)] sm:pb-28"
        style={{ paddingBottom: 'calc(6.5rem + var(--beco-mobile-ad-height, 0px))' }}
      >
        <MenuCatalog
          onProductSelect={setSelectedProduct}
